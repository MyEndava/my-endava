...
public class TagsRepository {
    ...
    public Completable removeTag(RemoveTagRequest request) {
    ...
    public Observable<List<TagSubCategory>> getAllTagSubCategories(){
        return mRetrofitClient.getRetrofitClient().getAllTagSubCategories();
    }
